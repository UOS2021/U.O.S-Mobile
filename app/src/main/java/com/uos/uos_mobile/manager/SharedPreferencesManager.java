 ...
 * <p>
 * SharedPreferences에 데이터 저장 및 불러오기를 쉽게 할 수 있도록 도와주는 클래스입니다. 사용시 open() 함수를
 * 통해 SharedPreferences에 접근, 사용 후에는 close() 함수를 통해 SharedPreferences 연결을 해제해줍니다.
 *
...
public class SharedPreferencesManager {
    ...
    /**
     * 연결된 SharedPreferences의 연결을 해제합니다. 잘못된 접근을 막기 위해 SharedPreferences 사용 후
     * close() 함수를 호출하는 것을 권장합니다.
     */
