...
public class Global {
    ...
    public class Network {
        ...
        public class Response {
            ...
            public final static String ORDER_SUCCESS = "0008";
            public final static String ORDER_FAILED = "0009";
            public final static String ORDER_ACCEPT = "0010";
            public final static String ORDER_REFUSE = "0011";
            public final static String ORDER_LIST = "0012";
            public final static String CHANGE_PW_SUCCESS = "0013";
            public final static String CHANGE_PW_FAILED = "0014";
            public final static String CHANGE_PHONE_SUCCESS = "0015";
            public final static String CHANGE_PHONE_FAILED = "0016";
            public final static String WITHDRAWAL_SUCCESS = "0017";
            public final static String WITHDRAWAL_FAILED = "0018";
            public final static String CARD_ADD_SUCCESS = "0019";
            public final static String CARD_ADD_FAILED = "0020";
            public final static String CARD_REMOVE_SUCCESS = "0021";
            public final static String CARD_REMOVE_FAILED = "0022";
            public final static String CARD_INFO = "0023";
            public final static String CARD_NOINFO = "0024";
            public final static String ORDER_CANCEL_SUCCESS = "0025";
            public final static String ORDER_CANCEL_FAILED = "0026";
            public final static String QR_IMAGE_SUCCESS = "0027";
            public final static String QR_IMAGE_FAILED = "0028";
        }
    }
